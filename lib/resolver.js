...
var DependencyResolver = function(logger) {
  ...
  var updateProvideMap = function(filepath, oldProvides, newProvides, newModules) {
    ...
    newModules.forEach(function(dep) {
      modulesMap[dep] = filepath;
    });
  };
  ...
  this.updateFile = function(filepath, content) {
    ...
    if (!fileMap[filepath]) {
      ...
      // console.log(parsed);
      updateProvideMap(filepath, [], parsed.provides, parsed.modules);
    ...
    updateProvideMap(filepath, fileMap[filepath].provides, parsed.provides, parsed.modules);
    fileMap[filepath] = parsed;
  };
